...
```groovy
implementation 'com.nextfaze.poweradapters:power-adapters:0.17.0'
implementation 'com.nextfaze.poweradapters:power-adapters-recyclerview-v7:0.17.0'
```
...
```groovy
implementation 'com.nextfaze.poweradapters:power-adapters-rxjava2:0.17.0'
implementation 'com.nextfaze.poweradapters:power-adapters-data-rxjava2:0.17.0'
```
...
```groovy
implementation 'com.nextfaze.poweradapters:power-adapters-kotlin:0.17.0'
implementation 'com.nextfaze.poweradapters:power-adapters-data-kotlin:0.17.0'
implementation 'com.nextfaze.poweradapters:power-adapters-rxjava2-kotlin:0.17.0'
implementation 'com.nextfaze.poweradapters:power-adapters-data-rxjava2-kotlin:0.17.0'
implementation 'com.nextfaze.poweradapters:power-adapters-recyclerview-v7-kotlin:0.17.0'
```
...
```groovy
implementation 'com.nextfaze.poweradapters:power-adapters-data:0.17.0'
```
